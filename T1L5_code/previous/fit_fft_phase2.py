...
y_reduced = pca2.fit_transform(output_difference)
...
pred_difference  = model_loaded.predict(X_reduced)  # Make predictions
pred_difference  = pca2_loaded.inverse_transform(pred_difference)  
