...
clean_data_folder='Task_2_Level_3'
...
df.to_csv(r"D:\important\Hensinki_Speech_Challenge_2024\my_project\result\%s\%s_result-fft.csv"%(data_folder,model_name), index=False)
