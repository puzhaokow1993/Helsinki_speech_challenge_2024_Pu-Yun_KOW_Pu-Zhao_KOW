...
max_=np.max(output_fft_magnitude)
min_=np.min(output_fft_magnitude)
...
history=model.fit(input_fft_magnitude, fft_magnitude_diff, epochs=100,  batch_size=8,validation_split=0.2, callbacks=callback_list,shuffle=True)
