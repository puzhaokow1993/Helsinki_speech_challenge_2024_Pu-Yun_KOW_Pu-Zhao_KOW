...
joblib.dump(pca, 'D:\important\Hensinki_Speech_Challenge_2024\my_project\model\Task_1_Level_4\pca_model.pkl')  # Save the PCA transformer
joblib.dump(poly, 'D:\important\Hensinki_Speech_Challenge_2024\my_project\model\Task_1_Level_4\poly_transformer.pkl')
joblib.dump(model, 'D:\important\Hensinki_Speech_Challenge_2024\my_project\model\Task_1_Level_4\polynomial_regression_model.pkl')  # Save the trained regression model

#%%
# Later, you can load and use them like this:
pca_loaded = joblib.load('D:\important\Hensinki_Speech_Challenge_2024\my_project\model\Task_1_Level_4\pca_model.pkl')
poly_loaded = joblib.load('D:\important\Hensinki_Speech_Challenge_2024\my_project\model\Task_1_Level_4\poly_transformer.pkl')
model_loaded = joblib.load('D:\important\Hensinki_Speech_Challenge_2024\my_project\model\Task_1_Level_4\polynomial_regression_model.pkl')
