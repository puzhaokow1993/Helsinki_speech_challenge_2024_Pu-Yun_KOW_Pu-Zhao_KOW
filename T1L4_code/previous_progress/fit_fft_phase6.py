...
input_phase = np.load(r'D:\important\Hensinki_Speech_Challenge_2024\my_project\dataset\%s\unwrapped_input_fft_phase.npy'%data_folder)
output_phase = np.load(r'D:\important\Hensinki_Speech_Challenge_2024\my_project\dataset\%s\unwrapped_output_fft_phase.npy'%data_folder)

output_difference = output_phase - input_phase
...
X_poly = poly.transform(X_reduced)  # Transform the input data
...
plt.figure()
plt.plot(y_reduced[sample,:], label='output', color='blue')
plt.plot(X_reduced[sample,:], label='predicted', color='red')
plt.show()

plt.figure()
plt.plot(y_reduced[sample+611,:], label='output', color='blue')
plt.plot(X_reduced[sample+611,:], label='predicted', color='red')
plt.show()
