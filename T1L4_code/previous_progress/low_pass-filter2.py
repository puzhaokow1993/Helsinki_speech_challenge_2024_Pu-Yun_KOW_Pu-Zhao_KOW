...
cutoff_freq = 4000  # Define the cutoff frequency for low-pass filtering

input_new_data=low_pass_filter(input_data, cutoff_freq, sampling_rate)

#%%
np.save(r'D:\important\Hensinki_Speech_Challenge_2024\my_project\dataset\%s\ConvAE\filter_input_data.npy'%data_folder, input_new_data)
...
plt.plot(input_new_data[sample,:], label='predicted', color='red')
plt.show()
