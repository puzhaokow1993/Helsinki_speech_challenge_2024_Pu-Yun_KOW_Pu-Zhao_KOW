...
model_name = 'ConvAE'
pred_data = np.load(r'%s\%s\pred_data.npy' % (path, model_name)).astype(np.int16)
...
df.to_csv(r"D:\important\Hensinki_Speech_Challenge_2024\my_project\result\%s\%s_result.csv"%(data_folder,model_name), index=False)
